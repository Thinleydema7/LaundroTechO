    ...
    <footer className="bg-primary-100 text-primary-900">
      <div className="container mx-auto py-12 px-4">
        <div className="grid md:grid-cols-4 gap-8">
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-primary-800">Quick Links</h3>
            <nav className="flex flex-col space-y-2">
              <Link href="/" className="text-primary-700 hover:text-primary-500 transition-colors duration-300">Home</Link>
              <Link href="/services" className="text-primary-700 hover:text-primary-500 transition-colors duration-300">Services</Link>
              <Link href="/bookings" className="text-primary-700 hover:text-primary-500 transition-colors duration-300">Bookings</Link>
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-primary-800">Our Services</h3>
          ...
          {/* Hours */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-primary-800">Business Hours</h3>
            <div className="space-y-2 text-primary-700">
              <p>Monday - Friday:</p>
              <p>8:00 AM - 8:00 PM</p>
              <p>Saturday - Sunday:</p>
